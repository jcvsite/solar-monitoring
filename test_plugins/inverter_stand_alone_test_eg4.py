# inverter_stand_alone_test_eg4.py
"""
A standalone test script for the plugins\inverter\eg4_modbus_plugin.
...
2. Configure your inverter settings in config.ini under [PLUGIN_INV_EG4]
3. Run the script from your terminal: python inverter_stand_alone_test_eg4.py
...
if __name__ == "__main__":
    ...
    instance_name = os.environ.get('INVERTER_INSTANCE_NAME', 'INV_EG4')
    
    print("="*80)
    print("EG4 Modbus Inverter Plugin - Standalone Test")
    print("="*80)
    ...
    try:
        ...
        print("\n🔌 Creating EG4 plugin instance...")
        plugin = Eg4ModbusPlugin(
            instance_name=f"Test_{instance_name}",
            plugin_specific_config=config,
            main_logger=logging.getLogger("EG4Test")
        )
