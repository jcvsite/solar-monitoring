...
def load_bms_config_from_file(config_file_path: str, instance_name: str) -> dict:
    ...
    Args:
        ...
        instance_name: Name of the BMS instance (e.g., 'BMS_Seplos_v3')
    ...
    bms_config = {
        ...
        "slave_address": config.getint(section_name, "slave_address", fallback=0),
    }
    ...
    if bms_config["connection_type"] == "tcp":
        ...
        bms_config.update({
            ...
            "baud_rate": config.getint(section_name, "baud_rate", fallback=19200),
